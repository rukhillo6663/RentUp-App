  ...
  return (
    ...
    >
      ...
      <ul className="hidden md:flex">
        <li className="px-6 py-3  rounded-full shadow-lg hover:bg-amber-800 hover:text-white">
          <Link to="home" smooth={true} duration={500}>
            Home
          </Link>
        </li>
      ...
      <div className="hidden md:flex">
        <button className="px-6 py-3 rounded-full shadow-lg bg-amber-800 text-white  hover:bg-amber-900 hover:text-white mx-2">

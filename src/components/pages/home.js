      ...
      <div className="max-w-7xl mx-auto md:flex md:flex-row-reverse md:items-center">
        ...
        <div className="md:w-1/2 md:pl-8">
          <div className="text-center md:text-left">
            ...
            Welcome to our  agency, where finding your dream home is our top priority. Our team of experienced agents is dedicated to providing exceptional service and helping you navigate the complex process of buying or selling a property
            </p>
